          ...
          <div className={styles.content}>
            <div className={styles.title}>
              ...
              <p>
                ...
                Quisquam, debitis. Soluta corporis ipsam, nemo tenetur possimus
                quas totam sunt sed.
              </p>
            </div>
            ...
            <div className={styles.title2}>
              ...
              <p>
                Hos oss skiftar du dina däck tryggt och säkert. Vi bjuder på
                kaffe och kaka medans du väntar.
              </p>
            </div>
          </div>
